  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      },
      {
        ...
        to: config.dev.assetsSubDirectory + '/XbsjCesium',
        toType: 'dir'
      },
      {
        from: './node_modules/earthsdk/dist/XbsjEarth',
        to: config.dev.assetsSubDirectory + '/XbsjEarth',
        toType: 'dir'
      },
      {
        from: './node_modules/earthsdk-plotting-symbol/dist/XbsjEarth-Plugins/plottingSymbol',
        to: config.dev.assetsSubDirectory + '/XbsjEarth-Plugins/plottingSymbol',
        toType: 'dir'
      },
      {
          ...
          to: config.dev.assetsSubDirectory + '/XbsjEarth-Plugins/customPrimitive',
          toType: 'dir'
      },      
    ])
  ]
